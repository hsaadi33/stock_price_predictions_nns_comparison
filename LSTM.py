...
def lstm(F,time_step,num_neurons, start_training_date,end_training_date,start_test_date,end_test_date):
	...
	F_series = scaler.fit_transform(np.array(F_series).reshape(-1,1))

	

	##Splitting dataset into train and test split
	train_data,test_data = F_series[0:training_size-time_step-1,:],F_series[training_size-time_step-1:len(F_series),:1]
